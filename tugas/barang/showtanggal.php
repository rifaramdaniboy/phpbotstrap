						...
						<div class="card-body">
							<form action="proses.php?aksi=update" method="post">
								<div class="form-group">
									...
									<input type="text" name="tanggal_meminjam" class="form-control" value="<?php echo $tanggal_meminjam?>" readonly >
								</div>							
								<div class="form-group">
									<label>Tanggal Kembali</label>
                                    <input type="text" name="tanggal_kembali" value="<?php echo $tanggal_kembali?>" class="form-control" readonly>
								</div>
								<a href="tanggal.php" class="btn btn-danger btn-block:">Back</a>
							</form>
						</div>
					</div>
				</div>
