...
?>
		...
		<br><center><h2 class="header-text">Informasi Barang</h2></center>
		<div class="row justify-content-center">
			<div class="col-md-10" style="padding: 20px;">
				<div class="card border-primary">
					<div class="card-body">
					<a href="createinformasi.php" class="btn btn-primary btn-block:">+ Tambah Masukan</a>
					<br><br>
						<table class="table">
						<tr>
							<th>No</th>
						...
						$no = 1;
						foreach ($informasi->index() as $data) {
						?>
						<tr>
							<td><?php echo $no++; ?></td>
							<td><?php echo $data['keadaan_barang']; ?></td>
							<td><?php echo $data['kekurangan_barang']; ?></td>
							<td><?php echo $data['kelebihan_barang']; ?></td>
							<td><?php echo $data['kritik']; ?></td>
							<td><a href="showinformasi.php?id=<?php echo $data['id']; ?>" class="btn btn-outline-primary btn-block:">Show</a></td>
                            <td><a href="editinformasi.php?id=<?php echo $data['id']; ?>" class="btn btn-outline-warning btn-block:">Edit</a></td>
                            <td>
                            <a class="btn btn-outline-danger btn-block:" href="prosesinformasi.php?id=<?php echo $data['id']; ?> &aksi=delete"
