...
<head>
    ...
    <title>Raport Siswa Assalaam</title>
</head>
<body>
                            ...
                            if (isset($_POST['simpan'])) {
                                ...
                                for ($a = 0; $a < $jml; $a++) { ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="nh[]" required>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="form-group">
                                    <button type="submit" name="simpan" class="btn btn-outline-primary">Pilih
                                    </button>
